...
# Add the offset to the ascii numbers with a wrap around.
ceasar_nums = map(lambda num: (num + ceasar_offset) % 128, ascii_nums)

# Convert the ascii numbers back to characters and join them to a string.
